export interface ElectronAPI {
  ...
  conversationClearActive: () => Promise<{ success: boolean; error?: string }>
  conversationClearMessages: () => Promise<{ success: boolean; session?: any; error?: string }>
  conversationDeleteAll: () => Promise<{ success: boolean; error?: string }>
